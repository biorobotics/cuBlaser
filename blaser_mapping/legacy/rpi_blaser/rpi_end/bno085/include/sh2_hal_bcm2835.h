...
#ifndef __SH2_HAL_BCM2835_H__
#define __SH2_HAL_BCM2835_H__

#define ADDR_SH2_0          (0x4B)  //I2C IMU slave device address
#define STARTUP_DELAY_MS    (500)
#define READ_LEN            (2)     //Number of bytes to read to determine length

/* Hardware specific pin declarations */
/* 
 Pin declarations follow BCM naming convention, listed below:
 +-----+-----+---------+------+---+-Pi ZeroW-+---+------+---------+-----+-----+
...
#define IMU_I2C_CLK_DIV (BCM2835_I2C_CLOCK_DIVIDER_626)

#endif /* __SH2_HAL_BCM2835_H__ */