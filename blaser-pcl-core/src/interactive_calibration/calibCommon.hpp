...
#define IMAGE_MAX_HEIGHT 960
    ...
    struct cameraParameters
    {
        ...
        cameraParameters(
            ...
            cv::Mat &_stdDeviations, double _avgError = 0)
            : cameraMatrix(_cameraMatrix), distCoeffs(_distCoeffs),
            stdDeviations(_stdDeviations), avgError(_avgError)
        {
        }
    };
